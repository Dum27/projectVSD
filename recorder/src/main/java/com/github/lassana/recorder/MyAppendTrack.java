...
/**
 * Created by taras on 12.05.2015.
 */
 ...
 * Created by taras on 12.05.2015.
 */
public class MyAppendTrack extends AppendTrack {
    private static Logger LOG = Logger.getLogger(AppendTrack.class);
    Track[] tracks;
    SampleDescriptionBox stsd;

    public MyAppendTrack(Track... tracks) throws IOException {
        this.tracks = tracks;
    ...
    private SampleDescriptionBox mergeStsds(SampleDescriptionBox stsd1, SampleDescriptionBox stsd2) throws IOException {
        ...
        if (!Arrays.equals(ref, cur)) {
            ...
            if (se != null) {
                stsd1.setBoxes(Collections.<Box>singletonList(se));
            } else {
                throw new IOException("Cannot merge!!!11!! " + stsd1.getBoxes(SampleEntry.class).get(0) + " and " + stsd2.getBoxes(SampleEntry.class).get(0));
            }
        }
        return stsd1;
    }
