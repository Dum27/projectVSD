...
public class AudioRecorder {
    ...
    public static interface OnStopListener extends OnException {
        public void onStopped(String activeRecordFileName);
    }
    ...
    class StopRecordTask extends AsyncTask<OnStopListener, Void, Exception> {
        ...
        protected void onPostExecute(Exception e) {
            ...
            if (e == null) {
                setStatus(AudioRecorder.Status.STATUS_READY_TO_RECORD);
                mOnStopListener.onStopped(mTargetRecordFileName);
            } else {
                setStatus(AudioRecorder.Status.STATUS_READY_TO_RECORD);
    ...
    public void stop(final OnStopListener listener) {
        StopRecordTask task = new StopRecordTask();
        task.execute(listener);
    ...
    private String getTemporaryFileName() {
        ...
        return Environment.getExternalStorageDirectory()
                + File.separator + "Temp_Record.mp4";
    }
